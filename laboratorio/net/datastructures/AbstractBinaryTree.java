...
public abstract class AbstractBinaryTree<E> extends AbstractTree<E>
   ...
   */
   ...
   // Método que retorna una lista con todos los nodos externos del árbol
    public List<Position<E>> externals() {
        List<Position<E>> externals = new ArrayList<>();
  ...
  // Método que retorna un mapa con todas las ramas del árbol
  public Map<Position<E>, List<Position<E>>> branchMap() {
      Map<Position<E>, List<Position<E>>> branchMap = new UnsortedTableMap<>();
      for (Position<E> external : externals()) {
          List<Position<E>> branch = new ArrayList<>();
          Position<E> current = external;
          while (current != null) {
              branch.add(current);
              current = parent(current);
          }
          // Invertir la lista para que vaya desde la raíz al nodo externo
          Collections.reverse(branch);
          branchMap.put(external, branch);
      }
      return branchMap;
  }
}
