 ...
 * @author Lautaro
 */
public class UbicacionMod extends javax.swing.JFrame {
    private Red red;
    ...
    public UbicacionMod() {
        ...
        for (Ubicacion ubi : red.getUbicaciones()) {
            jComboBox1.addItem(ubi.getCodigo());
        }
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setMaximumSize(new java.awt.Dimension(510, 303));
        jPanel1.setMinimumSize(new java.awt.Dimension(510, 303));
        ...
        jTextField1.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(233, 233, 233), 1, true));
        ...
        jLabel2.setText("Modificar Ubicacion");

        jLabel1.setFont(new java.awt.Font("SansSerif", 0, 14)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(0, 102, 102));
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("Seleccione un equipo y a continucion ingrese una nueva descripcion");
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_jButton1MouseClicked
        ubica.actualizar(new Ubicacion((String) jComboBox1.getSelectedItem(), jTextField1.getText()));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UbicacionMod().setVisible(true);
            }
        });
    }
