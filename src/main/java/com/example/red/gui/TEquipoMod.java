...
public class TEquipoMod extends javax.swing.JFrame {
    ...
    public TEquipoMod() {
        ...
        for(TipoEquipo tEqui: red.getTipoEquipo()){
        jComboBox1.addItem(tEqui.getCodigo());
        }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Modificar Tipo Equipo");

        jLabel4.setFont(new java.awt.Font("SansSerif", 0, 13)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(0, 102, 102));
        jLabel4.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel4.setText("Seleccione el tipo equipo y complete el campo para modificar");

        jLabel5.setFont(new java.awt.Font("SansSerif", 0, 13)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(0, 102, 102));
        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel5.setText("su descripcion, luego toque en \"Aceptar\".");
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        tEquipos.actualizar(new TipoEquipo((String)jComboBox1.getSelectedItem(),jTextField1.getText()));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TEquipoMod().setVisible(true);
            }
        });
    }
